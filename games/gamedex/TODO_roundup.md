# Roundup — shipped 2026-07-12 (v1.11.6)
...
- [~] 4. YouTube bot wall — device-side, can't beat it (nocookie already tried); added a persistent "Watch on YouTube" link so a walled embed always has a click-through
