...
STATUS_SVG = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img"
  ...
  <!--
    ...
    ring of seven nodes — is a smudge at 16px, and a favicon that only works at
...
def status_card(path: str) -> None:
    ...
    line(draw, px, 72, 304, "Live health for the seven-node k3s cluster at home — nodes, pods,",
