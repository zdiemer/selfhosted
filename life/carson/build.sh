#!/usr/bin/env bash
# Build the carson image and push it to GHCR.
#
...
#
# Re-run after editing anything under src/, then run upgrade.sh.
#
...
echo "==> Done. Run upgrade.sh to roll the Deployment and CronJob onto it."
echo "    (First push only: set the ghcr.io/zdiemer/carson package visibility"
